...
class TreeOfThoughtTool(BaseTool):
    ...
    def execute(
        ...
        **kwargs
        ...
        """执行思维树推理"""
        try:
            from simple_agent.tools.reasoning_tools import TreeOfThoughtTool as ToT
...
class IterativeOptimizerTool(BaseTool):
    ...
    def execute(
        ...
        **kwargs
        ...
        """执行迭代优化"""
        try:
            from simple_agent.tools.reasoning_tools import IterativeOptimizerTool as IOT
...
class SwarmVotingTool(BaseTool):
    ...
    def execute(
        ...
        **kwargs
        ...
        """执行群体投票"""
        try:
            from simple_agent.tools.reasoning_tools import SwarmVotingTool as SVT
...
class MultiPathOptimizerTool(BaseTool):
    ...
    def execute(
        ...
        **kwargs
        ...
        """执行多路径优化"""
        try:
            from simple_agent.tools.reasoning_tools import MultiPathOptimizerTool as MPO
